...
def editSocial(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('hoviewsocialsme')
    context = {'form': form}
    return render(request, 'base/socialform.html', context)
...
def addHomeContent(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('viewhomecontent')
...
def addMessageFrom(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('viewmessagefrom')
...
def addTestimonial(request):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            return redirect('viewtestimonials')
